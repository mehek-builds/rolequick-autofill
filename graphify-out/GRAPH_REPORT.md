...
Cohesion: 0.06
Nodes (8): ap(), runFill(), ap(), at(), cssEscape(), extractValidationErrors(), label(), nearestFieldEntryLabel()
...
Cohesion: 0.18
Nodes (12): gradeQuestion(), isFourPointScale(), ukBand(), answerChoiceBlock(), blockAlreadyAnsweredForGrade(), comboControlIn(), fillCombobox(), fillLeverApplication() (+4 more)

...
// degrees. Always black, and always transparent behind, so it merges into
// whatever surface it sits on. There is no reversed, tinted or accent-coloured
// variant, and it never sits on a tile. Geometry is the same artwork the website
// generates in scripts/generate-brand-assets.mjs; keep the two in sync.
